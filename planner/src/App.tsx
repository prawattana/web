...
export default function App() {
  ...
  // วันที่ที่มี event (สำหรับจุดบนแถบวัน)
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* ปุ่มเพิ่ม (FAB) แบบ iOS */}
      <button onClick={openNewFab}
        className="btn-primary bottom-safe fixed right-4 z-20 flex h-11 w-11 items-center justify-center rounded-full text-2xl leading-none shadow-xl">
        +
      </button>
